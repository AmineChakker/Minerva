...
<div class="card max-w-3xl">
    <div class="card-body">
        <h5 class="text-base font-semibold text-default-700 mb-5">New Parent</h5>
        ...
        <form action="{{ route('parents.store') }}" method="POST">
            ...
            <div class="grid sm:grid-cols-2 grid-cols-1 gap-4 mb-4">
                <div>
                    ...
                    <input class="form-input" name="phone" type="text" value="{{ old('phone') }}">
                </div>
                <div>
                    <label class="block text-sm font-medium text-default-700 mb-1.5">Occupation</label>
                    <input class="form-input" name="occupation" type="text" value="{{ old('occupation') }}">
                </div>
            </div>
            <div class="mb-4">
                <label class="block text-sm font-medium text-default-700 mb-1.5">Link to Students</label>
                <div class="space-y-2">
            ...
            <div class="flex items-center gap-3 mt-6">
                <button type="submit" class="btn bg-primary text-white">Save Parent</button>
                <a href="{{ route('parents.index') }}" class="btn bg-default-150">Cancel</a>
            </div>
        </form>
    </div>
</div>
