...
<i class="ti ti-chevron-right text-xs flex-shrink-0 text-default-400 rtl:rotate-180"></i>
<span class="font-medium text-default-700">Add Student</span>
@endsection
        ...
        <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid sm:grid-cols-2 grid-cols-1 gap-4 mb-4">
                <div>
                    ...
                    <input class="form-input w-full" name="admission_number" type="text" value="{{ old('admission_number') }}" required placeholder="e.g. ADM-2024-001">
                </div>
                <div>
            ...
            <div class="grid sm:grid-cols-2 grid-cols-1 gap-4 mb-4">
                <div>
                    ...
                    <input class="form-input w-full" name="enrollment_date" type="date" value="{{ old('enrollment_date', date('Y-m-d')) }}" required>
                </div>
                <div>
